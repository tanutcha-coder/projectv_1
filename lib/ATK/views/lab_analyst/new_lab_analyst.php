                ...
                <form method="get" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-grid gap-3">
                            <button class="w-100 btn btn-success btn-lg" type="submit" name="action" value="addlabana">Save</button>
