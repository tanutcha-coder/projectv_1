        ...
        <div class="container">
            <main class="px-3">
                ...
                <table id="QTtable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $labforbook_list->labroom_ID ?></td>
                            <td><?php echo $labforbook_list->labName ?></td>
                            <td><?php echo $labforbook_list->Status ?></td>
                ...
                <form method="get" action="">
                    ...
                    <input type="hidden" name="labroom_ID" value="<?php echo $labforbook_list->labroom_ID; ?>" />
